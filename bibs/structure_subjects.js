const SUBJECTS = {
	"Portraits" : [
		...
		"The portrait of a young %character with a %color hat and a big earing.",
		"An %adj_chara %material sculpture of the head of a %character.",
		"The portrait of a %adj_chara %character holding a baby %animal in her arms.",
		"A side portrait of a %adj_chara %character in rich clothes.",
		"The tilted head of a %adj_chara %character with long dark hair.",
		"A portrait of a %adj_chara %adj_chara %character, holding a purse, barely smiling.",
		"A portrait of a %character in ligh cloth, turning her back on us.",
		"A portrait of a %character wearing a %animal fur around neck.",
		"The royal portrait of a %character, well dressed, posing in the garden.",

const BIB_CHARACTERS = {
	...
	"Fairy Tales": ["king", "emperor", "empress", "knight", "princesse", "prince", "witch", "mage",],
	...
	"Plants, Vegetation": ["algae","aloe Vera","antarctic beech","azalea flower","banyan","baobab","birch","bonsai","bush","buttress roots tree","cactus","cedar","corn","dragon blood tree","lilies","mahogany","maple","mast tree","monkey puzzle tree","mushroom","oak","palm","papaya tree","poison ivy","ponderosa Pine","queensland bottle tree","sandbox trees","spruce","stone pine","sycamore tree","traveller’s tree","tree","vine","willow","yew tree",],
